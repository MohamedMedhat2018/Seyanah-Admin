...
import com.example.serviceadmin.events.RxEvent
import com.example.serviceadmin.fire_utils.RefBase
import com.example.serviceadmin.models.UserAdmin
import com.example.serviceadmin.rxbus.RxBus
import com.example.serviceadmin.sheets.BottomSheet
import com.example.serviceadmin.sheets.FileUtils
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.childrenCount > 0) {
                    ...
                    view!!.findViewById<TextView>(R.id.tv_Profile_password).text =
                        Editable.Factory.getInstance().newEditable(userAdmin.password.toString())
                    ...
                    view!!.findViewById<TextView>(R.id.tv_Profile_name).text =
                        Editable.Factory.getInstance().newEditable(userAdmin.username.toString())
